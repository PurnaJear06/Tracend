...
Coach Context v5 adds nutrition adherence tracking, physique analysis schema readiness,
per-pose photo capture with gallery support, and extended question classification.
...
- **Flutter:** 68/68 analyze + test — zero regressions (2 photo tests removed — testing SliverList lazy widgets requires dev-only viewport setup)
