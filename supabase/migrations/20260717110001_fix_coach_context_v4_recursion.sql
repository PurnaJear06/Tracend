-- fix: v4→v5→v4 infinite recursion introduced by 20260717110000
-- v4 was mistakenly redefined to call v5 while v5 calls v4.
-- restore v4 to its original implementation (calling v2).
