-- fix: "column meal_data does not exist" in prepare_coach_chat_v4 nutrition_focus branch
-- The inner subquery aliases the meal_items jsonb_agg as "foods", but the outer
-- jsonb_agg referenced a nonexistent column "meal_data".
-- Fix: reference "foods" and include meal metadata in the aggregated object.
